...
export const monthlySummarySchema = z.object({ month, income: money, expenses: money, savings: z.number().finite(), debtPayments: money, closingBalance: z.number().finite() })
